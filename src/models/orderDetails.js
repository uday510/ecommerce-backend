...
function listOrderDetails(data, cb) {
    var sql = `select * from ecommercedb.Users
     U INNER JOIN ecommercedb.OrderDetails
     O ON U.ID = O.UserID INNER JOIN
     ecommercedb.OrderItems OI ON O.ID = OI.OrderID 
     INNER JOIN ecommercedb.Products P ON P.ID = OI.ProductID 
     where U.ID = ?`;

/**
 *! select * from ecommercedb.Users U INNER JOIN ecommercedb.OrderDetails
 *!  O ON U.ID = O.UserID INNER JOIN ecommercedb.OrderItems OI ON 
 *! O.ID = OI.OrderID INNER JOIN ecommercedb.Products P ON 
 *! P.ID = OI.ProductID where U.ID = ?
 * 
 */
